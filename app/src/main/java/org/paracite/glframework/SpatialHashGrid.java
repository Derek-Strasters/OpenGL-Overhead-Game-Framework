...
public class SpatialHashGrid {
	...
	public int[] getCellIds(GameObject obj) {
		int x1 = (int) Math.floor((obj.bounds.center.x - obj.bounds.halfWidth) / cellSize);
		int y1 = (int) Math.floor((obj.bounds.center.y - obj.bounds.halfHeight) / cellSize);
		int x2 = (int) Math.floor((obj.bounds.center.x + obj.bounds.halfWidth) / cellSize);
		int y2 = (int) Math.floor((obj.bounds.center.y + obj.bounds.halfHeight) / cellSize);
		if (x1 == x2 && y1 == y2) {
